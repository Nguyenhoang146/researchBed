...
//                isValValid.setLeftExpression(new Column(temp_dmn.getName().concat(".val")));
...
//                caseExpression.setElseExpression(new Column(temp_dmn.getName().concat(".res")));
                
//                finalPlainSelect.setRes(new ResSelectExpression(caseExpression));

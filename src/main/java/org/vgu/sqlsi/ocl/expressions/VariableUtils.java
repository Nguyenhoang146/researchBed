...
public class VariableUtils {
    ...
    public static List<String> FVars(MyPlainSelect selectBody, String currentIter) {
        return selectBody.getVars().stream().map(var -> var.getVar()).filter(var -> !var.equals(currentIter)).collect(Collectors.toList());
    }

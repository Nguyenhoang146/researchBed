...
Blockly.JavaScript['attribute_string'] = function(block) {
  // Numeric value.
  var code = block.getFieldValue('ATTR');
  return [code, Blockly.JavaScript.ORDER_ATOMIC];
};

Blockly.JavaScript['class_string'] = function(block) {
  // Numeric value.
...
Blockly.JavaScript['action_add'] = function(block) {
  ...
  return ['ADD ' + argument0 + ' ' + argument1,
      Blockly.JavaScript.ORDER_DIVISION];
};

Blockly.JavaScript['action_do'] = function(block) {
  // Math operators with single operand.
  var operator = block.getFieldValue('OP');
  var argument0 = Blockly.JavaScript.valueToCode(block, 'N',
      Blockly.JavaScript.ORDER_COMMA) || '<number>';
  ...
  var argument2 = Blockly.JavaScript.valueToCode(block, 'LOGIC',
      Blockly.JavaScript.ORDER_COMMA) || '<condition>';    
  var code;
  switch (operator) {
    case 'EXACTLY':
      code = 'DO EXACTLY ' + argument0 + ' ' + argument1 + ' SUCH THAT ' + argument2;
      break;
    case 'AT MOST':
      code = 'DO AT MOST ' + argument0 + ' ' + argument1 + ' SUCH THAT ' + argument2;
      break;
    case 'AT LEAST':
      code = 'DO AT LEAST ' + argument0 + ' ' + argument1 + ' SUCH THAT ' + argument2;
      break;
    default:
      throw Error('Unknown quantifier: ' + operator);
  }
  return [code, Blockly.JavaScript.ORDER_DIVISION];
};
